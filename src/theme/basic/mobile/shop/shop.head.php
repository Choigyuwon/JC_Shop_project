...
<header id="hd">
    ...
    <div id="hd_wr">
        <div id="logo"><a href="<?php echo G5_SHOP_URL; ?>/"><img src="<?php echo G5_DATA_URL; ?>/common/mobile_logo_img" style="width: 70px; height: 140px;" alt="<?php echo $config['cf_title']; ?> 메인"></a></div>
        <div id="hd_btn">

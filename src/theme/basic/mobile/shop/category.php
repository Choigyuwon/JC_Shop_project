    ...
    <div class="menu_wr">
        ...
        <div class="content">
            ...
            foreach($mshop_categories as $cate1){
                ...
                if( count($cate1) > 1 )
                <?php
                echo '<button class="sub_ct_toggle ct_op">'.get_text($mshop_ca_row1['ca_name']).' <a href="<?php echo $mshop_ca_row1[\'url\']; ?>"><?php echo get_text($mshop_ca_row1[\'ca_name\']); ?></a></button>'.PHP_EOL;

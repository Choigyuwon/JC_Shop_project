    ...
    <div class="menu_wr">
        ...
        <div class="content">
            ...
            foreach($mshop_categories as $cate1){
                ...
                <?php
                if( count($cate1) > 1 )
                    echo '<button class="sub_ct_toggle ct_op" style="width: 430px;height: 40px;">'.get_text($mshop_ca_row1['ca_name']).' 하위분류 열기</button>'.PHP_EOL;
                /*
                 * <?php  if( count($cate1) > 1 ) {echo <button> zz</button>}
                */
                $j=0;

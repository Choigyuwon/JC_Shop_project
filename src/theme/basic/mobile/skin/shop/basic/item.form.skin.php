...
<form name="fitem" action="<?php echo $action_url; ?>" method="post" onsubmit="return fitem_submit(this);">
    ...
    <div id="sit_tab">
        <ul class="tab_tit">
            <li><button type="button" rel="#sit_inf" class="selected" style="width:20px; height:20px;">상품정보</button></li>
            <li><button type="button" rel="#sit_use" style="width:20px; height:20px;">사용후기</button></li>
            <li><button type="button" rel="#sit_dvex" style="width:20px; height:20px;">배송/교환</button></li>
        </ul>
        <ul class="tab_con">
